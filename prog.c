...
char *p;
char *q;
char S[2000] = "L@X-SGD-HNBBB-AD-VHSG--XNT\x1b[2J\x1b[H";
char *s = S;
char *G = "r2zZX!.+@KBK^yh.!:%Bud!.+Jyh.!6.BHBhp!6.BHBh!:%Buv{VT!.hBJ6p!042ljn!284b}`!.hR6Dp!.hp!h.T6p!h.p6!2/LilqP72!h.+@QB!~}lqP72/Lil!h.+@QBFp!:)0?F]nwf!,82v!.sv{6!.l6!,j<n8!.xN6t!&NvN*!.6hp";
#include <complex.h>
typedef complex double(c);
c(X)[3],P,O;c/**/B(double t){double s=1-t,u;P=
